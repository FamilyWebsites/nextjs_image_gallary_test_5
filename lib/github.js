...
const BASE_URL = 'https://api.github.com/repos/FamilyWebsites/';

export const fetchImages = async (repo) => {
  try {
    const FULL_IMAGES_REPO = `${BASE_URL}${repo}/contents/photos`;
    const THUMBNAILS_REPO = `${BASE_URL}${repo}/contents/photos/thumbnails`;
